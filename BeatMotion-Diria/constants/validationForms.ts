...
export const signInValidationSchema = {
  ...
  email: string().email("El email no es válido").required("El email es obligatorio"),
  password: string().min(8, "La contraseña debe tener al menos 8 caracteres").required("La contraseña es obligatoria").matches(
